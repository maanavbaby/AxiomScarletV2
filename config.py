...
# Bot and owner info
OWNER_USERNAME = getenv("OWNER_USERNAME", "CreativeAxiom")
BOT_USERNAME = getenv("BOT_USERNAME", "AxiomVcBot")
BOT_NAME = getenv("BOT_NAME", "AxiomMuzic")
ASSUSERNAME = getenv("ASSUSERNAME", "AxiomV4")
